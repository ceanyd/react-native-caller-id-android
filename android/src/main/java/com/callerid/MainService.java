...
public abstract class MainService extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        System.out.println("--------------");
        System.out.println(NotificationManagerCompat.getEnabledListenerPackages(context.getApplicationContext()).contains(context.getPackageName()));
    ...
    protected abstract void onIncomingCallAnswered(Context ctx, String number, Date start, Intent intent);
        ...
        switch (state) {
            ...
            case TelephonyManager.CALL_STATE_OFFHOOK:
                ...
                else
                {
                    isIncoming = true;
                    callStartTime = new Date();
                    onIncomingCallAnswered(context, savedNumber, callStartTime, intent);
                }
